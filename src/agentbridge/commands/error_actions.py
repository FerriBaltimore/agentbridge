...
def add_errors(sub):
    ...
    diagnose = add_parser(commands, 'diagnose', help='Unavailable until proxy diagnosis is verified')
    diagnose.add_argument('case_id', metavar='CASE')
    diagnose.add_argument('--account-ref', help='Ignored while diagnosis is unavailable')
    diagnose.add_argument('--model', help='Ignored while diagnosis is unavailable')
    diagnose.add_argument('--idempotency-key', help='Ignored while diagnosis is unavailable')
    diagnose.add_argument('--timeout', type=float, default=60, help='Ignored while diagnosis is unavailable')
