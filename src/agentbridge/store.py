...
from .account_reset_store import AccountResetStoreMixin, migrate_v9
...
class Store(AccountResetStoreMixin, AccountPauseStoreMixin, AccountRetirementStoreMixin, EvaluationStoreMixin, ProxyBindingStoreMixin,
