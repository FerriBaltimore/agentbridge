...
| Earned Codex resets | Explicit account-bound credit read and idempotent redemption through CLIProxyAPI; attempt persisted before mutation | Deterministic proxy/backend fixtures and one live read; private HTTP contract and live credit redemption unverified |
